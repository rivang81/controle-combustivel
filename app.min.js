...
const T = {
  pt: {
    ...
    labelPreco: () => usaUS() ? "Pre\xE7o por gal\xE3o (R$)" : "Pre\xE7o por litro (R$)",
    opcional: "opcional",
    ...
    vEquilibrio: (p) => `Etanol vale a pena at\xE9 <b>R$ ${fmt(precoExib(p), 2)}</b>/${usaUS() ? "gal\xE3o" : "litro"}.`,
    ...
    salvo: "\u2713 Salvo",
    salvoEconomia: (v) => `\u2713 Salvo \xB7 voc\xEA economizou R$ ${fmt(v, 2)}`,
    salvoGasto: (v) => `\u2713 Salvo \xB7 R$ ${fmt(v, 2)} a mais neste tanque`,
    ...
    falaVencedor: (nome, econ) => `${nome} compensa: economia de aproximadamente ${Math.round(econ)} reais no tanque de ${fmt(volExib(config.tanqueLitros), 0)} ${usaUS() ? "gal\xF5es" : "litros"}.`,
  ...
  en: {
    ...
    salvo: "\u2713 Saved",
    salvoEconomia: (v) => `\u2713 Saved \xB7 you saved R$ ${fmt(v, 2)}`,
    salvoGasto: (v) => `\u2713 Saved \xB7 R$ ${fmt(v, 2)} extra on this tank`,
...
function aoDitar() {
  ...
  if (r.preco !== null) {
    ...
    partes.push(`R$ ${fmtInput(r.preco)}/${uVol()}`);
  }
